        ...
        >
          <form onSubmit={handleSubmit} id="contactme-section" border="2px solid blue">
            <Text fontSize="4xl" fontWeight="bold" color="white" mb={6}>
              Contact me
                ...
                <form onSubmit={handleSubmit} border="2px solid blue">
                    <FormControl id="name" mb={4} isInvalid={!!nameError}>
                      <FormLabel color="white" fontSize="2xl">Name</FormLabel>
                      <Input
                        type="text"
                    ...
                    <FormControl id="email" mb={4} isInvalid={!!emailError}>
                      <FormLabel color="white"  fontSize="2xl">Email address</FormLabel>
                      <Input
                        type="email"
                    ...
                    <Text color="white"  fontSize="2xl">Type of enquiry</Text>
                    <Select
                      id="typeOfEnquiry"
                    ...
                    <FormControl id="message" mb={4}>
                      <FormLabel color="white"  fontSize="2xl">Your Message</FormLabel>
                      <Textarea
          ...
          {showSuccessMessage && (
            <Alert status="success" mt={4}>
              ...
              <AlertDescription>Thank for your submission Mark, we will get back to you shorty!</AlertDescription>
            </Alert>
          )}
        </Box>
